  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-[#E0E2E5] pb-6">
        <h1 className="text-4xl font-bold text-black uppercase tracking-tight leading-none">Taxonomy Reference</h1>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {/* Inclusions */}
        <Card title="Inclusions" subtitle="The Brand" color="#000000">
        ...
        {/* Context */}
        <Card title="Context" subtitle="The Anchor (NEAR/15)" color="#ED1C24">
          <ul className="space-y-2">
        ...
        {/* Exclusions */}
        <Card title="Exclusions" subtitle="The Noise (NOT)" color="#6706EF">
          <ul className="space-y-2">
      ...
      <div className="bg-[#000000] text-white p-10 rounded-sm mt-8 border border-[#1A1C1D]">
        <h3 className="font-bold uppercase tracking-wide mb-6">BigQuery SQL Syntax Reference</h3>
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h4 className="text-[#ED1C24] font-bold text-xs uppercase tracking-widest mb-3">Efficiency (LIKE)</h4>
            <code className="block bg-[#1A1C1D] p-6 rounded-sm text-sm font-mono text-[#E0E2E5]">
              WHERE caption LIKE '%Dynacord%' <br/>
              <span className="text-[#595E62]">-- Fast. Uses Search Indexes. Best for unique names.</span>
            </code>
          </div>
          <div>
            <h4 className="text-[#6706EF] font-bold text-xs uppercase tracking-widest mb-3">Precision (REGEX)</h4>
            <code className="block bg-[#1A1C1D] p-6 rounded-sm text-sm font-mono text-[#E0E2E5]">
              REGEXP_CONTAINS(caption, r'(?i)\bEV\b') <br/>
              <span className="text-[#595E62]">-- Use \b boundaries. Avoids matching "Level".</span>
            </code>
          </div>
        </div>
      </div>
