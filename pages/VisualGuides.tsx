  ...
  return (
    <div className="space-y-20 animate-fade-in pb-12">
       ...
       <header className="border-b border-[#E0E2E5] pb-8">
        <h1 className="text-4xl font-bold text-black uppercase tracking-tighter leading-none mb-4">Query Blueprints</h1>
        <p className="text-[#595E62] text-lg">Visualizing the logic structures for high-precision data fetching.</p>
      </header>
          ...
          <div className="min-w-[700px] flex flex-col items-center space-y-6">
            ...
            <div className="flex justify-between w-full max-w-3xl px-12 relative pt-6">
               ...
               <div className="flex flex-col items-center w-1/2 pr-8 space-y-6">
                  <div className="bg-[#ED1C24] text-white px-4 py-1 rounded-sm text-xs font-bold uppercase tracking-widest">YES (High Risk)</div>
                  <ArrowDown className="text-[#979EA4]" />
                  <div className="bg-[#F8FAFC] border border-[#979EA4] p-6 rounded-sm text-center w-full">
                    ...
                    <div className="text-sm text-[#595E62]">Must link to Category (Speaker, Mic)</div>
                  </div>
                  <ArrowDown className="text-[#979EA4]" />
               ...
               <div className="flex flex-col items-center w-1/2 pl-8 space-y-6">
                  <div className="bg-[#000000] text-white px-4 py-1 rounded-sm text-xs font-bold uppercase tracking-widest">NO (Unique)</div>
                  <ArrowDown className="text-[#979EA4]" />
                  <div className="bg-[#F8FAFC] border border-[#979EA4] p-6 rounded-sm text-center w-full">
                    <div className="font-bold text-black uppercase mb-2">Simple Inclusion</div>
                    <div className="text-sm text-[#595E62]">Use standard OR operator</div>
                  </div>
                  <ArrowDown className="text-[#979EA4]" />
            ...
            <div className="bg-white border border-[#979EA4] text-black px-10 py-5 rounded-sm text-center shadow-sm w-2/3">
              <span className="font-bold uppercase">Add Global Exclusions (NOT)</span> <br/>
              <span className="text-sm text-[#595E62] mt-2 block">Remove obvious noise (Tesla, Poker)</span>
            </div>
          </div>
        </div>
      </section>
       ...
       <section className="scroll-mt-8" id="hierarchy">
        ...
        <div className="grid md:grid-cols-2 gap-8">
           <div className="bg-white p-8 rounded-sm shadow-sm border border-[#E0E2E5]">
             <h3 className="font-bold uppercase text-sm text-[#979EA4] mb-6 tracking-widest">Order of Specificity</h3>
             <div className="space-y-2">
               <div className="relative">
                 ...
                 <div className="w-48 mx-auto bg-[#6706EF] text-white p-4 text-center font-bold z-40 relative shadow-lg">
                   "Quotes" <span className="block text-[10px] uppercase opacity-70 mt-1">Exact Match</span>
                 </div>
                 <div className="w-64 mx-auto bg-gradient-to-r from-[#8538F2] to-[#B382F7] text-white p-4 text-center font-bold z-30 relative shadow-md -mt-2">
                   NEAR/x <span className="block text-[10px] uppercase opacity-70 mt-1">Proximity</span>
                 </div>
                 <div className="w-80 mx-auto bg-gradient-to-r from-[#979EA4] to-[#B2B9C0] text-black p-4 text-center font-bold z-20 relative shadow-md -mt-2">
                   AND <span className="block text-[10px] uppercase opacity-60 mt-1">Presence</span>
                 </div>
                 <div className="w-full mx-auto bg-[#E0E2E5] text-black p-4 text-center font-bold z-10 relative shadow-sm -mt-2">
                   OR <span className="block text-[10px] uppercase opacity-60 mt-1">Selection</span>
                 </div>
               </div>
             </div>
           </div>
           ...
           <div className="bg-[#1A1C1D] p-8 rounded-sm shadow-sm text-white">
              <h3 className="font-bold uppercase text-sm text-[#979EA4] mb-6 tracking-widest">Nesting Logic</h3>
              <div className="font-mono text-sm space-y-6">
                <div className="p-6 bg-black rounded-sm border-l-4 border-[#00FF00]">
                   <span className="text-[#595E62] uppercase text-xs mb-2 block">// Correct Nesting</span>
                ...
                <div className="p-6 bg-[#2E3033] rounded-sm border-l-4 border-[#ED1C24]">
                   <span className="text-[#ED1C24] uppercase text-xs font-bold mb-2 block flex items-center gap-2"><AlertTriangle size={12}/> Incorrect (Ambiguous)</span>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="border border-[#E0E2E5] rounded-sm overflow-hidden bg-white shadow-sm hover:border-[#ED1C24] transition-colors group">
            <div className="bg-[#F8FAFC] p-6 border-b border-[#E0E2E5] flex justify-between items-center">
              <h3 className="font-bold text-[#595E62] uppercase tracking-wide flex items-center gap-2 group-hover:text-[#ED1C24]"><X size={20}/> The Leaky Bucket</h3>
              <span className="text-[10px] font-bold bg-[#ED1C24] text-white px-2 py-1 uppercase">Precision: &lt; 10%</span>
            </div>
            <div className="p-8 space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-sm text-[#595E62] flex gap-3">
                  <span className="font-bold text-black shrink-0">1.</span> Matches keywords anywhere in doc.
                </p>
                <p className="text-sm text-[#595E62] flex gap-3">
                   <span className="font-bold text-black shrink-0">2.</span> "EV" matches loosely (Tesla, Poker).
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border border-[#E0E2E5] rounded-sm overflow-hidden bg-white shadow-sm hover:border-[#6706EF] transition-colors group">
            <div className="bg-[#F8FAFC] p-6 border-b border-[#E0E2E5] flex justify-between items-center">
              <h3 className="font-bold text-[#595E62] uppercase tracking-wide flex items-center gap-2 group-hover:text-[#6706EF]"><Check size={20}/> The Laser Focus</h3>
              <span className="text-[10px] font-bold bg-[#6706EF] text-white px-2 py-1 uppercase">Precision: &gt; 90%</span>
            </div>
            <div className="p-8 space-y-6">
              <div className="font-mono text-sm bg-black text-[#00FF00] p-6 rounded-sm">
               ...
               <div className="space-y-4">
                <p className="text-sm text-[#595E62] flex gap-3">
                  <span className="font-bold text-black shrink-0">1.</span> Contextual Anchor locks meaning.
                </p>
                <p className="text-sm text-[#595E62] flex gap-3">
                   <span className="font-bold text-black shrink-0">2.</span> Unique terms are separated.
                </p>
              </div>
            </div>
          </div>
