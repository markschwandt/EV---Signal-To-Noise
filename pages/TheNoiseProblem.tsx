  ...
  return (
    <div className="space-y-12 animate-fade-in">
      <div className="text-center max-w-2xl mx-auto mb-16">
        <h1 className="text-4xl font-bold text-black uppercase tracking-tight leading-none mb-6">The "EV" Identity Crisis</h1>
        <p className="text-lg text-[#595E62]">
          The acronym "EV" is one of the most overloaded terms in the English language. 
          Without precision engineering, our data is worthless.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="bg-white border-2 border-[#ED1C24] rounded-sm p-10 relative overflow-hidden shadow-sm">
          ...
          <h2 className="text-2xl font-bold text-[#ED1C24] mb-6 flex items-center gap-3 uppercase tracking-tight">
            <Zap size={24} /> The Noise (99%)
          </h2>
          <ul className="space-y-4">
            {[
              "Automotive: Tesla, Rivian, Charging, Range Anxiety",
              "Finance: +EV (Expected Value in Poker/Betting)",
              "Photography: EV (Exposure Value)",
              "Biology: Extracellular Vesicles"
            ].map((item, i) => (
        ...
        <div className="bg-black border border-black rounded-sm p-10 relative overflow-hidden shadow-2xl transform md:-translate-x-6 text-white">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3 uppercase tracking-tight">
                <Volume2 size={24} className="text-[#00FF00]"/> The Signal (1%)
            </h2>
            <ul className="space-y-4">
                {[
                "Professional Audio: Line Array, Subwoofer, PA",
                "Product Lines: ZLX, EVERSE, RE20, EVID",
                "Context: 'Live Sound', 'Gig', 'Sound Check'",
                "Dynacord Link: Amps, Mixers, SONICUE"
                ].map((item, i) => (
      ...
      <div className="bg-white p-12 rounded-sm border border-[#E0E2E5] shadow-sm mt-8">
        <h3 className="text-xl font-bold text-black uppercase tracking-tight mb-8">The Solution: Contextual Anchors</h3>
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-sm font-mono">
          <div className="flex-1 bg-[#F8FAFC] p-6 rounded-sm text-center border border-[#E0E2E5] opacity-50">
            "EV"
            <div className="text-xs text-[#979EA4] uppercase mt-2 tracking-widest">Too Broad</div>
          </div>
          <div className="text-[#979EA4] font-bold">→</div>
          <div className="flex-1 bg-[#F8FAFC] p-6 rounded-sm text-center border border-[#E0E2E5] opacity-50">
            "EV" AND "Speaker"
            <div className="text-xs text-[#979EA4] uppercase mt-2 tracking-widest">Risky</div>
          </div>
